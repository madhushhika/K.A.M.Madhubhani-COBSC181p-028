...
class CreatePostViewController: UIViewController {
   ...
   /* ---------------Article Share Method------------------*/
    ...
    func saveImage(profileImageURL: URL , completion: @escaping ((_ url: URL?) -> ())){
        let result = ["Description": article_Des.text!, "imageUrl": profileImageURL.absoluteString,"Title": articleTitle.text!,"PublisherName": article_User.text!] as [String : Any]
...
extension CreatePostViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    internal func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let pickedImage = info[UIImagePickerController.InfoKey.editedImage] as? UIImage {
            self.article_image.image = pickedImage
        }
